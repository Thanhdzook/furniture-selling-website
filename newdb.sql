...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 20, 2023 lúc 05:57 PM
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`prd_id`) REFERENCES `product` (`id`);
...
ALTER TABLE `order1`
  ...
  ADD CONSTRAINT `order1_ibfk_2` FOREIGN KEY (`id_cart`) REFERENCES `cart` (`id`);
